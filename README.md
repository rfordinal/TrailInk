...
| Pressing the buttons from the host | built 2026-09-08, **unverified on hardware** — `CMD:BUTTON <name> [holdMs]` injects a real press, so a laptop can walk to screens that used to need a thumb. Devel builds only. See [`docs/serial-button-injection.md`](./docs/serial-button-injection.md) |
