...
Status: **flashed and read on a LilyGo T5 S3 Pro, 2026-09-07**, from
`release/lilygo-t5-s3-pro` before it merged here. All four tabs were grabbed off the panel with
